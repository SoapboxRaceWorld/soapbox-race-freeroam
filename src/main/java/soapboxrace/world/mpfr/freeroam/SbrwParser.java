...
import soapboxrace.world.mpfr.utils.UdpDebug;
...
public class SbrwParser
{
    ...
    public boolean parseInputData(byte[] inputData)
    {
        ...
        try
        {
            ...
            {
                System.err.println("[packet] out-of-order time: " + time);
    ...
    {
        byte[] hexStringToByteArray = UdpDebug.hexStringToByteArray(
                "00:01:07:02:e3:32:1d:1e:ff:ff:ff:ff:43:4c:29:c9:00:22:00:00:63:68:61:6e:6e:65:6c:2e:45:4e:5f:5f:32:00:00:01:67:c3:7b:d0:fc:33:00:63:ef:76:00:00:00:00:00:c0:01:41:00:4e:49:4c:5a:41:4f:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:00:01:00:00:00:00:00:00:00:65:00:00:00:00:00:00:00:b0:79:e6:cf:ee:1e:9c:fb:1b:9f:c2:dc:00:00:00:00:12:1a:0b:78:98:0d:7d:19:d6:eb:44:29:c4:25:89:c4:20:27:b8:0f:23:2d:2d:2d:34:50:00:7f:3e:6a:3d:2a");
        SbrwParser sbrwParser = new SbrwParser(hexStringToByteArray);
        System.out.println(UdpDebug.byteArrayToHexString(sbrwParser.getHeader()));
        System.out.println(UdpDebug.byteArrayToHexString(sbrwParser.getCrc()));
        System.out.println(UdpDebug.byteArrayToHexString(sbrwParser.getChannelInfo()));
        byte[] playerInfo = sbrwParser.getPlayerInfo();
        System.out.println(UdpDebug.byteArrayToHexString(playerInfo));
        System.out.println(UdpDebug.byteArrayToHexString(sbrwParser.getCarState()));
        System.out.println("[" + sbrwParser.getName() + " - " + sbrwParser.getPlayerId() + "]");
        System.out.println("[" + sbrwParser.getChannel() + "]");
        System.out.println("X = " + sbrwParser.getXPos());
        System.out.println("Y = " + sbrwParser.getYPos());
    }
}
